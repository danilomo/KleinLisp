...
public class LexerDebugTest extends BaseTestClass {
  ...
  public void testParseDoubleLiteral() {
    ...
    System.out.println(
        "Is DoubleObject: " + (result instanceof net.sourceforge.kleinlisp.objects.DoubleObject));
    System.out.println(
        "Is IntObject: " + (result instanceof net.sourceforge.kleinlisp.objects.IntObject));
    assertTrue(
        result instanceof net.sourceforge.kleinlisp.objects.DoubleObject,
  ...
  public void testParseIntLiteral() {
    ...
    assertTrue(
        result instanceof net.sourceforge.kleinlisp.objects.IntObject,
  ...
  public void testAddMixedDebug() {
    ...
    assertTrue(
        result instanceof net.sourceforge.kleinlisp.objects.DoubleObject,
        "(+ 1 1.2) should return DoubleObject but was "
            + result.getClass().getSimpleName()
            + " = "
            + result);
    assertEquals("2.2", result.toString(), "(+ 1 1.2) should be 2.2 but was " + result);
  }
  ...
  public void testNestedMixedDebug() {
    ...
    assertTrue(
        mul instanceof net.sourceforge.kleinlisp.objects.DoubleObject,
