...
public interface SymbolFactory {
  ...
  /**
   * newSymbol creates a symbol with a value, grouping other symbols with left/right locations; used
   * frequently by the parser to implement non-terminal symbols
   *
  ...
  /**
   * newSymbol creates a symbol, grouping other symbols with left/right locations; used frequently
   * by the parser to implement non-terminal symbols
   *
   * @param name Textual name for the Symbol for verbose error messages
   * @param id enum value associated with this symbol, generated by cup via sym.java
   * @param left symbol, to take the left location from
  ...
  /**
   * newSymbol creates a basic symbol with an attached value; used frequently for terminal symbols
   * like identifiers
   *
   * @param name Textual name for the Symbol for verbose error messages
   * @param id enum value associated with this symbol, generated by cup via sym.java
